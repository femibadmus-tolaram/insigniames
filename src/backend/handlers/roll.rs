use crate::backend::models::{IdPayload, Roll, RollCreatePayload, RollFilterPayload, RollPayload};
...
pub async fn create_roll(
    ...
    data: web::Json<RollCreatePayload>,
...
pub async fn roll_details(
    ...
    let conn = conn_data.get().unwrap();
    match Roll::get_details(&conn, data.id) {
