...
!(function (t, e) {
	...
	function N(t) {
		return (
			!(function (t) {
				return (
					"symbol" == typeof t || ("object" == typeof t && null !== t && !(Symbol.toPrimitive in t || "toString" in t || "valueOf" in t))
				);
			})(t) &&
			!isNaN(parseFloat(t)) &&
			isFinite(t)
	...
	class tn extends $s {
		...
		fit() {
			...
			if (o) {
				...
				if (
					(a ? ((t.width = this.maxWidth), (t.height = Js(n) + o)) : ((t.height = this.maxHeight), (t.width = Js(n) + o)),
	...
	var go = Object.freeze({
		...
		BarElement: class extends $s {
			...
			draw(t) {
				...
				t.save(),
					(o.w === n.w && o.h === n.h) ||
						(t.beginPath(), a(t, fo(o, e, n)), t.clip(), a(t, fo(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
					t.beginPath(),
					a(t, fo(n, e)),
					(t.fillStyle = s),
					t.fill(),
	...
	class bo extends tn {
		...
		buildTicks() {
			...
			const n = (function (t, e) {
				...
				for (
					x &&
					(u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, xo(a, y, t)) && D++) : M < a && D++);
					D < k;
					++D
				) {
		...
		beforeElementsUpdate: (t, e, i) => {
			...
			t.data.datasets.forEach((e, o) => {
				...
				let { start: d, count: u } = (function (t, e) {
					...
					return (
						l && (n = Z(it(e, o.axis, a).lo, 0, i - 1)), (s = h ? Z(it(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s }
					);
				})(l, h);
				...
				for (const t of s) {
					...
					for (const e of h) {
						const s = ea(i, o[e.start], o[e.end], e.loop),
							r = Ri(t, n, s);
						for (const t of r)
							a.push({ source: t, target: e, start: { [i]: sa(l, s, "start", Math.max) }, end: { [i]: sa(l, s, "end", Math.min) } });
					}
				}
				return a;
			})(i, s, n);
	...
	class Wa extends $s {
		...
		_getActiveElements(t, e, i, s) {
			...
			if (!s)
				return e.filter(
					(t) =>
						this.chart.data.datasets[t.datasetIndex] && void 0 !== this.chart.getDatasetMeta(t.datasetIndex).controller.getParsed(t.index)
				);
